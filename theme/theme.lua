...
-- theme.wallpaper					= os.getenv("HOME") .. "/Pictures/Wallpapers/Patterns/memphis-colorful/memphis-colorful.png"
-- theme.font                                      = "Noto Sans CJK KR 10"
theme.font                                      = "Sarasa Mono K Bold 10"
theme.taglist_font                              = "Noto Sans CJK Bold 8, Sarasa Mono K Bold 9"
...
theme.border_normal                             = "#1D252C"
theme.border_focus                              = "#1D252C"
...
local blue   = "#80CCE6"
local space3 = markup.font("Sarasa Mono K Bold 10", " ")

-- Clock
local mytextclock = wibox.widget.textclock(markup("#FFFFFF", space3 .. "%I:%M   " .. markup.font("Sarasa Mono K Bold 4", " ")))
...
-- Calendar
local mytextcalendar = wibox.widget.textclock(markup.fontfg(theme.font, "#FFFFFF", space3 .. "%b %d " .. markup.font("Sarasa Mono K Bold 4", " ")))
...
theme.mpd = lain.widget.mpd({
	  settings = function ()
		 if mpd_now.state == "play" then
			...
			widget:set_markup(markup.font("Sarasa Mono K Bold 10", " ")
								 .. markup.font(theme.taglist_font,
												" " .. mpd_now.artist
												   .. " - " ..
												   mpd_now.title .. "  ") .. markup.font("Sarasa Mono K Bold 10", " "))
			play_pause_icon:set_image(theme.pause)
		 elseif mpd_now.state == "pause" then
			widget:set_markup(markup.font("Sarasa Mono K Bold 10", " ") ..
								 markup.font(theme.taglist_font, " MPD PAUSED  ") ..
								 markup.font("Sarasa Mono K Bold 10", " "))
...
batwidget.tooltip.wibox.font = "Sarasa Mono K Bold 8"
-- Initial message
...
local net = lain.widget.net({
	  settings = function()
		 widget:set_markup(markup.font("Sarasa Mono K Bold 10", " ") .. markup.font(theme.font, net_now.received .. " - "
...
-- Separators
local first = wibox.widget.textbox('<span font="Sarasa Mono K Bold"> </span>')
...
function theme.at_screen_connect(s)
   ...
   awful.tag({ "  ", "  ", "  ", "  ", "  " }, s, awful.layout.suit.floating)
